...
export const products: Product[] = [
  ...
  },
  {
    ...
    image: staticProductImage("wisada-ad-car-man.png"),
    heroImageFit: "cover",
    carouselImageFit: "cover",
    quantityUnit: "set",
    images: [
      staticProductImage("wisada-ad-car-man.png"),
      staticProductImage("wisada-ad-compare-infographic.png"),
      staticProductImage("wisada-ad-features-car.png"),
    ],
    detailImage: staticProductImage("wisada-ad-compare-infographic.png"),
    afterPainImage: staticProductImage("wisada-ad-features-car.png"),
    storyImages: [
      staticProductImage("wisada-ad-car-man.png"),
      staticProductImage("wisada-ad-compare-infographic.png"),
    ],
