...
export const products: Product[] = [
  ...
  },
  {
    ...
    pains: [
      ...
      "بغيتي حل كامل بدل منتج واحد؟",
      "كتقلبي على هدية عملية؟",
    ],
    mechanism:
