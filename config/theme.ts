...
/**
 * Visual tokens per niche. Comfort keeps the original teal/ivory store.
 * Watches uses a darker steel + champagne boutique look.
...
/** Charcoal steel + champagne — watch boutique, not the old teal comfort look */
