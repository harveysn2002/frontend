...
const products: Product[] = [
  // ── دعامة قوس القدم ───────────────────────────────────────────────────────
  {
    ...
    subheading:
      "ملي القوس كيكون منهار، باطن الرجل كيلامس الأرض بالكامل وكيزيد الضغط. مشد VORLAY بوسادة جل كيدعم القوس ويوزّع الضغط — للقدم المسطحة وراحة الوقوف والمشي. زوج كامل (L و R).",
