...
const products: Product[] = [
  // ── دعامة قوس القدم ───────────────────────────────────────────────────────
  {
    ...
    headline: "قدم مسطحة، وقوف طويل، ولا ضغط من تحت؟",
    subheading:
      "مشد مرن بوسادة جل مدمجة — كيلف منتصف الرجل ويعطي دعم خفيف تحت القوس. للقدم المسطحة والاستعمال اليومي. زوج كامل (L و R)، مقاس موحد، دار أو حذاء.",
    ...
    pains: [
      "عندك قدم مسطحة وكتحس الرجل بلا دعم من تحت؟",
      "كتوقف بزاف ولا كتمشي مدة طويلة ورجليك كيتعبو من البداية؟",
      "بغيت دعم بسيط تحت القوس بلا نعال ثقيل ولا معقد؟",
    ],
    painResponses: [
      "مشد VORLAY بوسادة جل كيدعم القوس ويخفّف إحساس الضغط — مخصوص للقدم المسطحة والراحة اليومية.",
      "ضغط خفيف ومرن كيعاونك تكمل نهارك واقف ولا ماشي براحة أكثر.",
      "خفيف وعملي — دار، خدمة، ولا مع الحذاء. زوج كامل. الدفع عند الاستلام.",
    ],
    mechanism:
      "المشد كيلف منتصف القدم وكتثبت بحزام الكعب. وسادة الجل تحت القوس كتعطي رفع خفيف ودعم للقدم المسطحة، وكتساعد على توزيع الضغط أثناء الوقوف والمشي — دعم يومي للراحة، بلا وعود علاجية.",
