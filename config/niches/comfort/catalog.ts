...
const products: Product[] = [
  // ── دعامة قوس القدم ───────────────────────────────────────────────────────
  {
    ...
    subheading:
      "ملي القوس كيكون منهار، باطن الرجل كيلامس الأرض بالكامل وكيزيد الضغط. مشد VORLAY بوسادة جل كيدعم القوس ويوزّع الضغط — مناسب للنساء والرجال والأطفال. زوج كامل (L و R).",
    cardHeading: "مشد دعم قوس القدم",
    cardSubheading: "وسادة جل مدمجة — نساء · رجال · أطفال",
    bestFor: ["نساء ورجال وأطفال", "القدم المسطحة", "الوقوف والمشي"],
    benefits: [
      ...
      "زوج كامل مع L و R — مناسب للنساء والرجال والأطفال، مقاس مرن.",
    ...
    eyebrow: "VORLAY · نساء ورجال وأطفال · زوج كامل · الدفع عند الاستلام",
