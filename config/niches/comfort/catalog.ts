...
const products: Product[] = [
  // ── دعامة قوس القدم ───────────────────────────────────────────────────────
  {
    ...
    nameEn: "VORLAY Arch Support Compression Sleeve",
    headline: "قدم مسطحة؟ ضغط من تحت ملي كتوقف؟",
    subheading:
      "ملي القوس كيكون منهار، باطن الرجل كيلامس الأرض بالكامل وكيزيد الضغط. مشد VORLAY بوسادة جل كيدعم القوس ويوزّع الضغط — للنساء والرجال والأطفال من مقاس حذاء 34 فما فوق. زوج كامل (L و R).",
    cardHeading: "مشد دعم قوس القدم",
    cardSubheading: "وسادة جل مدمجة — من مقاس 34 فما فوق",
    bestFor: ["من مقاس 34 فما فوق", "القدم المسطحة", "الوقوف والمشي"],
    benefits: [
      "مشد مرن يلتف حول منتصف القدم — ضغط خفيف وثبات مزيان.",
      "وسادة جل مدمجة تحت القوس — دعم للقدم المسطحة وامتصاص خفيف للصدمات.",
      "نسيج سباندكس قابل للتنفس — مريح فالاستعمال اليومي.",
      "حزام كعب كيخلي المشد ثابت — ما كتزلقش ملي كتمشي ولا تقف.",
      "المقاس: مرن وموحّد — أقل مقاس حذاء مناسب تقريباً 34 (طول القدم ~21.5–22 سم). أصغر من 34 غالباً ما كيجيش مضبوط.",
      "زوج كامل مع L و R — نساء ورجال وأطفال (من 34 فما فوق).",
      "كتلبس حافي القدم فالدار ولا مع الجراب والحذاء — رقيق وما كيبانش.",
    ],
    pains: [
      "عندك قدم مسطحة والقوس كيبان منهار — footprint كامل وضغط على باطن الرجل؟",
      "كتوقف ولا كتمشي وكتحس ثقل وتعب من تحت القدم بسرعة؟",
      "بغيت دعم تحت القوس يخفّف الضغط — بلا نعال ثقيل ولا معقد؟",
    ],
    painResponses: [
      "وسادة الجل كترفع القوس خفيف وتدعم القدم المسطحة — باش الرجل ما تبقاش كاملة على الأرض.",
      "المشد كيوزّع الضغط من تحت وكيخليك تكمل نهارك واقف ولا ماشي براحة أكثر.",
      "حلّ عملي: دعم للقدم المسطحة + راحة فالوقوف. زوج كامل. الدفع عند الاستلام.",
    ],
    mechanism:
    ...
    eyebrow: "VORLAY · من مقاس 34 فما فوق · زوج كامل · الدفع عند الاستلام",
    ...
    faqs: [
      {
        ...
        a: "المشد مرن ومقاس موحد. أقل مقاس مناسب تقريباً 34 (طول القدم ~21.5–22 سم — طفل كبير / مراهق). أصغر من 34 غالباً ما كيجيش مضبوط وقد يتزحلق، خاصة إلا كانت الرجل رقيقة بزاف.",
      },
    ],
    images: [
    ...
    offers: [
      ...
      },
      {
        ...
        quantity: 2,
        title: "4 قطع",
        subtitle: "زوجين — واحد ليك وواحد كهدية",
        badge: "وفّر أكثر",
        priceMad: 200,
        compareAtPriceMad: 278,
      },
    ],
  },
  // ── دعامة الركبة المعززة ──────────────────────────────────────────────────
  {
    ...
    benefits: [
      "صفيحتان ألومنيوم قابلتان للطي على الجانبين — ثبات قوي بدون تقييد الحركة.",
      "وسادة EVA سميكة تحيط بالرضفة وتمتص الصدمات.",
      "أحزمة فيلكرو مرنة قابلة للتعديل لضبط الشد بحرية.",
      "خياطة دقيقة مقاومة للتآكل — تدوم مع الاستعمال المتكرر.",
      "وزن خفيف (249 غ) — سهل اللبس طوال النهار.",
      "مقاس واحد يناسب الجميع — إبزيم خطاف لاصق سهل التركيب والنزع.",
    ],
    pains: [
      "ركبتك كتوجعك في المشي أو الوقوف الطويل؟",
      "كتحس الركبة ما عندهاش ثبات فالحركة؟",
      "دعامات أخرى جربتيها ما بقاتش ثابتة أو ما جابتش نتيجة؟",
    ],
    painResponses: [
      "دعامة VORLAY بصفيحتين معدنيتين جانبيتين كتعطي الركبة ثبات حقيقي — مش مجرد ضغط قماش.",
      "وسادة EVA سميكة حول الرضفة + أحزمة فيلكرو قابلة للتعديل — ثبات مخصص حسب جسمك.",
      "خياطة مقاومة للتآكل + إبزيم خطاف — تلبسيها لدقيقتين وتخرجي كاملة الثقة.",
    ],
    mechanism:
    ...
    images: [
      ...
      staticProductImage("knee-pain-grid.png"),
      staticProductImage("knee-sports-ar.png"),
    ...
    offers: [
      {
        ...
        quantity: 1,
        title: "قطعة واحدة",
        subtitle: "دعامة معدنية لركبة واحدة",
        badge: "الأكثر اختياراً",
        priceMad: 229,
        compareAtPriceMad: 320,
        recommended: true,
      },
      {
        id: "knee-2",
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    headline: "مسند الجلوس اللي كيخفّف الضغط من التحت",
    subheading:
      "مسند بشكل U للجلوس الطويل فالمكتب والسيارة. كيخفّف الضغط من التحت وكيعاونك تجلس مرتاح مدة أطول — باش تكمل نهارك بظهر هاني وراحة أكثر.",
    cardHeading: "مسند جلوس بشكل U",
    ...
    painResponses: [
      "مسند VORLAY بفتحة من الورّا كيخفّف الضغط من التحت وكيخلي الجلسة أهدى.",
    ...
    mechanism:
      "المسند بتصميم U كيخفّف تركّز الضغط من التحت أثناء الجلوس الطويل، وكيوزّع الوزن باش الجلسة تكون أثبت وأهدى فالمكتب أو السيارة — بلا وعود علاجية.",
    eyebrow: "VORLAY · مسند جلوس للراحة اليومية · الدفع عند الاستلام",
    image: staticProductImage("maqad-hero.jpg"),
    heroImageFit: "contain",
    carouselImageFit: "contain",
    quantityUnit: "piece",
    images: [
...
export const comfortCatalog: NicheCatalog = { products, upsellOffers };
