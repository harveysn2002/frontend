...
const products: Product[] = [
  // ── دعامة قوس القدم ───────────────────────────────────────────────────────
  {
    ...
    headline: "ضغط من تحت فالوقوف؟ ولا عندك قدم مسطحة؟",
    subheading:
      "مشد مرن بوسادة جل مدمجة — حلّين فواحد: يخفّف ضغط القدم ملي كتوقف ولا تمشي، ويدعم قوس القدم المسطحة. زوج كامل (L و R)، مقاس موحد، دار أو حذاء.",
    cardHeading: "مشد دعم قوس القدم",
    cardSubheading: "وسادة جل مدمجة — زوج كامل · رجال ونساء",
    bestFor: ["القدم المسطحة", "الوقوف والمشي", "الاستعمال اليومي"],
    benefits: [
      ...
      "زوج كامل مع L و R — رجال ونساء، مقاس موحد.",
      "كتلبس حافي القدم فالدار ولا مع الجراب والحذاء — رقيق وما كيبانش.",
    ],
    pains: [
      "كتوقف بزاف فالخدمة ولا الدار وكتحس ضغط وتعب من تحت القدم؟",
      "عندك قدم مسطحة وكتحس الرجل كتلقى على الأرض بلا دعم للقوس؟",
      "بغيت حل بسيط يخدم الوقوف الطويل وأصحاب القدم المسطحة بجوج؟",
    ],
    painResponses: [
      "وسادة الجل كتوزّع الضغط من تحت وكتخلي الوقوف والمشي أهدى — مش مجرد ضغط قماش.",
      "المشد كيرفع القوس خفيف وكيدعم القدم المسطحة — باش الرجل ما تبقاش مسطحة بالكامل على الأرض.",
      "حلّ واحد، جوج فوائد: راحة فالوقوف + دعم للقدم المسطحة. زوج كامل. الدفع عند الاستلام.",
    ],
    mechanism:
      "المشد كيلف منتصف القدم وكتثبت بحزام الكعب. وسادة الجل تحت القوس كتخفّف ضغط الوقوف والمشي، وكتعطي دعم خفيف لأصحاب القدم المسطحة — دعم يومي للراحة، بلا وعود علاجية.",
