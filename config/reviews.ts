    ...
    reviews: [
      {
        ...
        date: "20 يناير 2026",
        variant: "أسود",
        text: "دعم ممتاز لأسفل الظهر. تقريباً كامل. كنستعمل دعم الظهر فالطوموبيل وأنا راضي بزاف بشكل عام. الميموري فوم كيتأقلم مباشرة مع الظهر وكيعطي الدعم بالضبط فين خاصو. الظهر كيبقى مستقيم بشكل واضح، حتى فالطريق الطويلة — مريح بزاف وأقل تعب من غير دعم. الصناعة عالية الجودة، ما كيزلقش وكيبقى ثابت فبلاصتو. الراحة والوظيفة فأعلى مستوى. العيب الصغير الوحيد: الفوم طري شوية، زيادة 10–15٪ ديال القساحة غاتكون مثالية ليا. ولكن هادشي عيب بسيط بزاف. فالمجمل، نصيحة واضحة بالشراء. تقريباً كامل للاستعمال اليومي فالطوموبيل.",
      },
      {
        name: "4***r",
        rating: 5,
      ...
      },
      {
        ...
        date: "19 غشت 2025",
        variant: "أسود",
        text: "هادي ثاني وحدة كنشري، للطوموبيل الآخر. مصنوعة مزيان وكتعطي دعم. الفوم كيرجع لبلاصتو مزيان.",
      },
      {
        name: "l***k",
        rating: 5,
