    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "11 أبريل 2026",
        text: "بالنسبة ليا، التعديل زوين بزاف. كنقول مزيان حيت كيعاون على الوضعية بشكل واضح، والثمن مناسب. ساهل فالتركيب وما كيزعجنيش نهائياً. راضي بالشراء.",
        helpful: 2,
      },
      {
        name: "مشتريت ڤورلاي",
        rating: 5,
        date: "17 أبريل 2026",
        text: "عجبني بزاف. المواد حسّيتها بجودة عالية، والتصميم زوين. طلبت المقاس المتوسط، طولي 1.64م ووزني 62 كغ. كننصح بيه بزاف للي عندو انحناء فالظهر. استشير المعالج ديالك المختص.",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 5,
        date: "01 غشت 2025",
        text: "منتج مزيان، كننصح بيه. التوصيل جا بسرعة وكيخدم مزيان باش يعاون على الوضعية.",
      },
      {
        name: "مشتريت ڤورلاي",
        rating: 5,
        date: "24 أبريل 2026",
        text: "رغم الشحن من برّا، وصل فحوالي خمسة أيام وفاجئني بالسرعة. لحد دابا كنستعملو بلا مشاكل. خاصية تعديل الشد زوينة بزاف.",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 5,
        date: "21 مارس 2026",
        text: "حاجة زوينة وفعّالة، فرحان بالشراء. هادي ثاني مرة كنشري منو.",
      },
      {
        name: "مشتريت ڤورلاي",
        rating: 5,
        date: "20 أكتوبر 2025",
        text: "ممتاز، ولاكن خديت مقاس أصغر. إن شاء الله غادي نشري مقاس أكبر.",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 5,
        date: "28 دجنبر 2025",
        text: "مثالي، راضي بزاف بالملمس والجودة.",
      },
      {
        name: "مشتريت ڤورلاي",
        rating: 5,
        date: "16 أكتوبر 2025",
        text: "باكر بزاف باش نعرف واش كيخدم، ولاكن الجودة باينة كافية بالنسبة للثمن.",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 5,
        date: "28 مارس 2026",
        text: "راضي بزاف بالطلب. شكراً للجميع.",
      },
      {
        name: "مشتريت ڤورلاي",
        rating: 5,
        date: "10 أبريل 2026",
        text: "كلشي مطابق، غادي نلبسو.",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 5,
        date: "12 نونبر 2025",
        text: "فرحان بالشراء. كيخدم بحال ما مكتوب.",
      },
      {
        name: "مشتريت ڤورلاي",
        rating: 5,
        date: "24 أبريل 2026",
        text: "عجبني، بحال الصورة بالضبط. شكراً بزاف.",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 5,
        date: "30 أبريل 2026",
        text: "كيخدم مزيان ووصل قبل المتوقع.",
      },
      {
        name: "مشتريت ڤورلاي",
        rating: 5,
        date: "29 ماي 2026",
        text: "الزوج عجبو وخدم معاه مزيان.",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 5,
      ...
      },
      {
        ...
        rating: 5,
        date: "12 أكتوبر 2025",
        text: "ساهل فاللبس وكيجي مزبوط على الجسم.",
        helpful: 1,
      },
      {
        name: "مشتريت ڤورلاي",
        rating: 5,
        date: "30 أبريل 2026",
        text: "المنتج باين متين. مازال ما شفت النتيجة حيت غير بدّيت نستعملو، ولاكن متشوق نشوف الفرق.",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 5,
      ...
      },
      {
        ...
        rating: 4,
        date: "06 نونبر 2025",
        text: "وصل مزيان. السلعة زوينة بزاف 👍",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 4,
        date: "30 يوليوز 2025",
        text: "الطلب وصل كما متوقع وشكله مرتب. المقاس كيجي صغير شوية. معلّب مزيان ووصل بسرعة.",
      },
      {
        name: "مشتريت ڤورلاي",
        rating: 5,
        date: "09 نونبر 2025",
        text: "كننصحو تطلبو مقاس أكبر من اللي فالجدول.",
      },
      {
        name: "مشتري ڤورلاي",
        rating: 5,
